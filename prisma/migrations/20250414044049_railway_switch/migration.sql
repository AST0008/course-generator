...
-- CreateIndex
CREATE INDEX "courseId" ON "Unit"("coursId");

-- CreateIndex
CREATE INDEX "unitID" ON "Chapter"("unitId");

-- CreateIndex
CREATE INDEX "chapter_question_index" ON "Question"("chapterId", "question");
...
-- AddForeignKey
ALTER TABLE "Unit" ADD CONSTRAINT "Unit_coursId_fkey" FOREIGN KEY ("coursId") REFERENCES "Course"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
